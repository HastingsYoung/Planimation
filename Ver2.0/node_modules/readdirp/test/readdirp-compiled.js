...
test('\n\nreading root using function filter', function (t) {
  t.test('\n# file filter -> "contains root_dir2"', function (t) {
    t.plan(1);
    readdirp(opts({ fileFilter: function fileFilter(fi) {
  ...
  t.test('\n# directory filter -> "name has length 9"', function (t) {
    t.plan(1);
    readdirp(opts({ directoryFilter: function directoryFilter(di) {
...
test('\nprogress callbacks', function (t) {
  ...
  var pluckName = function pluckName(fi) {
    return fi.name;
  },
      processedFiles = [];
...
test('resolving of name, full and relative paths', function (t) {
  var expected = {
    ...
    fullPath: 'test/bed/root_dir1/root_dir1_file1.ext1'
      ...
      opts = [{ root: './bed', prefix: '' }, { root: './bed/', prefix: '' }, { root: 'bed', prefix: '' }, { root: 'bed/', prefix: '' }, { root: '../test/bed/', prefix: '' }, { root: '.', prefix: 'bed' }];
  t.plan(opts.length);
...
//# sourceMappingURL=readdirp-compiled.js.map